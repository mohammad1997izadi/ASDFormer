...
def main(cfg: DictConfig):
    ...
    group_name = f"ASDFormer_{cfg.model.feature_encoder_hidden}_{cfg.model.dim_reduc_ratio}_{cfg.model.dim_reduc_hidden}_{cfg.model.expert_hidden}_{cfg.model.classifier_hidden}_{cfg.model.gate_hidden}_{cfg.model.k1}_{cfg.model.k2}_{cfg.model.num_hidden_layers}_{cfg.model.regularization_co}"
